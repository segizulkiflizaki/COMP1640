<?php
  ...
  if ($mysqli === FALSE) { echo "Check database connection!"; }
  
  echo '<h1><pre>';
  get_user($mysqli, 'administrator@gmail.com', 'Abcd7890()'); echo PHP_EOL;
  get_user($mysqli, 'john@outlook', 'secret'); echo PHP_EOL;
  
  get_user($mysqli, 'administrator@gmail.com', 'my secret@!'); echo PHP_EOL;
